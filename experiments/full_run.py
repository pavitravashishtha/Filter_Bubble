import sys
import os
# Allow running as both `python experiments/full_run.py` and `python -m experiments.full_run`
...
def run_full_research_simulation():
    ...
    print("=== FILTER BUBBLE SIMULATION — RESEARCH RUN 001 ===")
    ...
    with open("experiments/run_001_summary.json", "w") as f:
        json.dump(results_summary, f, indent=2)
    print("Summary saved to experiments/run_001_summary.json")
